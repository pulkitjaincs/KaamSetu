...
const actions = [
    ...
    { href: '/my-jobs', iconBg: 'rgba(34, 197, 94, 0.1)', iconColor: '#22c55e', icon: 'bi-briefcase', title: 'View My Jobs', subtitle: 'Manage your job listings' },
    { href: '/my-team', iconBg: 'rgba(59, 130, 246, 0.1)', iconColor: '#3b82f6', icon: 'bi-people', title: 'My Team', subtitle: 'Manage your hired workers' },
];
