                    ...
                    <div className="card border-0 shadow-lg auth-card">
                        ...
                        <div className="card-body p-4 p-md-5">
                                        ...
                                        {emailMethod === 'password' && (
                                            <div className="mb-4">
                                                <label className="form-label fw-medium small text-uppercase d-flex justify-content-between auth-form-label">
                                                    Password
                                                    <Link href="/forgot-password" className="text-decoration-none auth-link" style={{ textTransform: 'none', letterSpacing: 'normal' }}>Forgot?</Link>
                                                </label>
                                                <input
                                                    type="password"
                                                    className="form-control border-0 py-3 auth-form-control"
                            ...
                            <p className="text-center mb-0 auth-text-muted">
                                New to SkillAnchor?{' '}
                                <Link href="/register" className="fw-semibold text-decoration-none auth-text-main">Create an account</Link>
                            </p>
                        </div>
                    </div>
